...
short_description: Module create txt files

# If this is part of a collection, you need to use semantic versioning,
# i.e. the version is of the form "2.5.0" and not "2.4".
version_added: "1.0.0"

description: This module creates txt files on remote host with content.
...
options:
    path:
        ...
        type: str
    content:
        description: File's content, which could be written to file
        required: true
        type: bool
...
author:
    - Orlov Dmitriy (https://github.com/Borodatko)
'''
